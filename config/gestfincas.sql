...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-05-2026 a las 00:02:02
...
(41, 8, 5, 'pendiente', NULL),
(42, 8, 6, 'pendiente', NULL);
...
(2, 7, 'AT27HI5O', 1, '2026-05-28 23:09:51');
...
(1, 1, 'Apertura piscina', 'Se informa que la temporada de piscina 2026 estará abierta del  1 Junio al 15 Septiembre', 'normal', '2026-05-26 10:15:10');
...
(8, 2, 'Votación derrama ascensor', 'Se tratará en la junta extraordinaria la derrama extraordinaria para el arreglo del ascensor', '2026-05-18', '20:00:00', 'Portal', '[\"1. Se presentan las cuentas al día\",\"2. Se presenta la situación del ascensor\",\"3. Se proponen soluciones\",\"4. Se realiza votación\"]', 'public/uploads/reuniones/8.pdf', 'convocada', '2026-05-15 20:37:04');
...
(6, 7, 'Natalia', 'Moreno Perez', '20030067H', 'gestfincas.app@gmail.com', '$2y$10$90qX//an6y.uZC69BCD5pO4XUw6mYYBGPwHLrH4UEwHlPIwi8.zPG', '2026-05-28 23:20:16', 1, 'vecino');
...
ALTER TABLE `incidencias`
  ...
  ADD KEY `id_vivienda` (`id_vivienda`),
  ADD FULLTEXT KEY `texto_normalizado` (`texto_normalizado`);
...
--
ALTER TABLE `codigo_validacion`
  MODIFY `id_codigo` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `incidencias`
  MODIFY `id_incidencias` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de la tabla `proveedores`
--
ALTER TABLE `proveedores`
  MODIFY `id_proveedor` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `reunion`
  MODIFY `id_reunion` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `vivienda`
  MODIFY `id_vivienda` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
