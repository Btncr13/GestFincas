...
class AuthController
{
    ...
    public function panelvecino()
    {
        ...
        if (empty(trim($direccion))) { $direccion = 'Calle Mayor 45, 28001 Madrid'; }
        ...
        $incidencias = [
            ['id' => 1, 'titulo' => 'Fuga de agua en el garaje', 'estado' => 'en_curso', 'categoria' => 'Fontanería'],
            ['id' => 2, 'titulo' => 'Luz fundida en el portal', 'estado' => 'pendiente', 'categoria' => 'Electricidad'],
            ['id' => 3, 'titulo' => 'Puerta del garaje atascada', 'estado' => 'resuelta', 'categoria' => 'Cerrajería']
        ];
