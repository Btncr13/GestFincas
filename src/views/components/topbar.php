    ...
    <div class="container-fluid p-0 d-flex justify-content-between align-items-center">
        ...
        <div class="d-none d-md-flex">
            <?php if ($rol === 'presidente'): ?>
                <a href="index.php?route=auth/panelvecino" class="btn btn-outline-light rounded-pill btn-sm d-flex align-items-center gap-2 px-3 py-2" style="border-color: rgba(255,255,255,0.2); font-size: 0.85rem; color: white;">
                    <i class="fa-solid fa-house"></i> 
                    <span class="d-none d-sm-inline">Cambiar a Vecino</span>
                </a>
            <?php endif; ?>
        </div>
