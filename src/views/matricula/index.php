    ...
    <div class="row flex-nowrap m-0">
        ...
        <main class="col-12 col-md-9 col-lg-10 ms-auto px-2 px-md-4 pt-3 pt-md-4 pb-5">
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4">
                <div>
                    <h2 class="fw-bold mb-1 font-title">Parking</h2>
                    <p class="text-muted small mb-0">Control de vehículos de la comunidad</p>
                </div>
                <?php if ($rol !== 'presidente'): ?>
                    <button type="button" class="btn btn-success text-white fw-semibold shadow-sm d-flex align-items-center gap-2" data-bs-toggle="modal" data-bs-target="#modalMatricula">
            ...
            <?php if (isset($_SESSION['parking_success'])): ?>
                <div class="alert alert-success alert-dismissible fade show border-0 shadow-sm" role="alert" style="border-radius: var(--radio-md);">
                    <i class="fa-solid fa-check-circle me-2"></i> <?= $_SESSION['parking_success'] ?>
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                </div>
                <?php unset($_SESSION['parking_success']); ?>
            <?php endif; ?>
            ...
            <?php if (isset($_SESSION['parking_error'])): ?>
                <div class="alert alert-danger alert-dismissible fade show border-0 shadow-sm" role="alert" style="border-radius: var(--radio-md);">
                    <i class="fa-solid fa-circle-exclamation me-2"></i> <strong>Atención:</strong> <?= $_SESSION['parking_error'] ?>
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                </div>
                <?php unset($_SESSION['parking_error']); ?>
            <?php endif; ?>
