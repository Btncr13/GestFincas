        ...
        <main class="col-12 col-md-9 col-lg-10 ms-auto px-2 px-md-4 pt-3 pt-md-4 pb-5 d-flex flex-column min-vh-100">
            <div class="container-fluid p-0 position-relative">
                ...
                <div class="card border-0 mb-4 overflow-hidden shadow-sm banner-presi-card">
                    <img src="public/assets/img/banner.jpeg" alt="Comunidad" class="card-img w-100 h-100 object-fit-cover position-absolute banner-presi-img">
                    <div class="card-img-overlay d-flex flex-column justify-content-end p-4 text-white">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                <h2 class="mb-1 fw-bold text-white text-shadow-main font-titulos">Gestión de Usuarios</h2>
                                <p class="mb-0 fw-semibold text-white text-shadow-sub fs-5">Directorio de vecinos y gestión de roles</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="d-flex flex-wrap align-items-center gap-3 mb-4">
                    ...
                    <div class="d-flex flex-wrap gap-2 ms-auto">
                        ...
                        <button class="btn btn-outline-secondary fw-semibold shadow-sm d-flex align-items-center gap-2" onclick="prepararModificacion()">
...
<!-- CONTENEDOR TOAST (Fuera de la etiqueta <main>) -->
...
document.addEventListener('DOMContentLoaded', function() {
    // 1. GESTIONAR ERRORES DE SESIÓN (EL ÚNICO PHP QUE NECESITA JS)
    ...
    // 3. Validación en tiempo real de los Modales (Crear y Modificar)
    ...
    // 4. Limpiar formularios al cerrar o cancelar los modales
